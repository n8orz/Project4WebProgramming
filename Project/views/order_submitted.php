...
<div class="container-fluid">
  <div class="row">
    ...
    <div id ="second_column" class="col-md-8 text-center">
        <h1 class="display-4 text-center font-weight-normal">Thank you for your order!</h1>
        <p class="lead text-center">As an up and coming company it means a lot! We have taken the liberty of logging you out and will send you an email with your confirmation number.
